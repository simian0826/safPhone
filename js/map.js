(function(config) {
    ...
    function la() {
        ...
        return 0 <= a.indexOf("nvidia") || 0 <= a.indexOf("quadro") || 0 <= a.indexOf("geforce") || 0 <= a.indexOf("nvs") ? (b = ["nVidia"], 0 <= a.indexOf("geforce") && b.push("geForce"), 0 <= a.indexOf("quadro") && b.push("Quadro"), 0 <= a.indexOf("nvs") && b.push("NVS"), a.match(/\bion\b/) && b.push("ION"), a.match(/gtx\b/) ? b.push("GTX") : a.match(/gts\b/) ? b.push("GTS") : a.match(/gt\b/) ? b.push("GT") : a.match(/gs\b/) ? b.push("GS") : a.match(/ge\b/) ? b.push("GE") : a.match(/fx\b/) && b.push("FX"), (c = a.match(ka)) && b.push(c[1].toUpperCase().replace("GS", "")), 0 <= a.indexOf("titan") ? b.push("TITAN") : 0 <= a.indexOf("ti") && b.push("Ti"), b = b.join(" ")) : 0 <= a.indexOf("amd") || 0 <= a.indexOf("ati") || 0 <= a.indexOf("radeon") || 0 <= a.indexOf("firegl") || 0 <= a.indexOf("firepro") ? (b = ["AMD"], 0 <= a.indexOf("mobil") && b.push("Mobility"), c = a.indexOf("radeon"), 0 <= c && b.push("Radeon"), 0 <= a.indexOf("firepro") ? b.push("FirePro") : 0 <= a.indexOf("firegl") && b.push("FireGL"), 0 <= a.indexOf("hd") && b.push("HD"), 0 <= c && (a = a.substring(c)), (c = a.match(ka)) && b.push(c[1].toUpperCase().replace("HD", "")), b = b.join(" ")) : a.substring(0, 100)
    }
    ...
    Eb = !wb || Ya || xa || kb && eb || Sa || Ga || Ba || Ca || Ma || e("gt-n710") || wa,
    ...
    window.AMap.Ai = "1.3.27.6";
    var Xb = window.AMap.wC = {},
    Yb = config[2].split(",")[0],
    Zb = Yb + "/theme/v" + config[4] + "/style1.3.27.6.css",
    ...
    function oc(a) {
        ...
        c.charset = "utf-8";
        c.src = a; (a = b.body || $b) && a.appendChild(c)
    }
    function pc() {
        for (var a = Yb + "/maps/main?v=" + config[4] + "&key=" + config[0] + "&m=" + config.fN.join(",") + "&vrs=1.3.27.6", b = document.getElementsByTagName("script"), c, d = 0; d < b.length; d += 1) if (0 === b[d].src.indexOf(Yb.split(":")[1] + "/maps?")) {
            c = b[d];
            break
        }
...
})(["0339a9e4f17c228650d6a412aa9b07c7", [105.28976, 28.160225, 110.199858, 32.201187, 106.504962, 29.533155], "http://webapi.amap.com", 1, "1.3", null, "500000", "AMap.PolyEditor,AMap.CircleEditor", true, true, true])
